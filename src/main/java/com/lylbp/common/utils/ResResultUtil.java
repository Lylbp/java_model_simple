...
public class ResResultUtil {
    ...
    public static <T> ResResult<T> makeRsp(int code, String msg) {
        return new ResResult<T>().setCode(code)
                .setMsg(msg);
    }
    ...
    public static <T> ResResult<T> makeRsp(ResResultEnum responseEnum) {
        return new ResResult<T>().setCode(responseEnum.getCode())
    ...
    public static <T> ResResult<T> success() {
        return new ResResult<T>().setCode(ResResultEnum.SUCCESS.getCode())
                .setMsg(ResResultEnum.SUCCESS.getMsg());
    }
    ...
    public static <T> ResResult<T> error() {
        return new ResResult<T>().setCode(ResResultEnum.SYSTEM_ERR.getCode())
                .setMsg(ResResultEnum.SYSTEM_ERR.getMsg());
    }
    ...
    public static <T> ResResult<PageResResult<T>> makePageRsp(PageResResult<T> pageResult) {
        return new ResResult<PageResResult<T>>().setCode(ResResultEnum.SUCCESS.getCode())
                .setMsg(ResResultEnum.SUCCESS.getMsg())
                .setData(pageResult);
    }
}
