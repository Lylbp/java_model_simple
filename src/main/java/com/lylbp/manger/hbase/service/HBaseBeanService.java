...
import com.lylbp.manger.hbase.entity.HClazzMapping;
import com.lylbp.manger.hbase.entity.HPage;
import com.lylbp.manger.hbase.handler.DefaultHandler;
import com.lylbp.manger.hbase.handler.FieldMapper;
...
import com.lylbp.manger.hbase.util.HBaseUtil;
...
public class HBaseBeanService<T> {
    ...
    public HClazzMapping<T> getHClazzMapping(Class<T> clazz) throws HbaseAnnotationException, InstantiationException {
        //获取表名
        com.lylbp.manger.hbase.annotion.HTable hTableAnnotation = clazz.getAnnotation(HTable.class);
